...
@onready var fireball_spawner: Node2D = $FiraballSpawner
...
func _on_attck_range_body_entered(body: Node2D) -> void:
	movement_component.max_speed = 0
	attack_range = true


func _on_attck_range_body_exited(body: Node2D) -> void:
